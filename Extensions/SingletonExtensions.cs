...
static public class SingletonExtensions
{
    ...
    /// <summary>
    /// Sets all singletons instances that exists in the scene.
    /// Slow, recommanded in startup time only, do not call frequently.
    /// </summary>
    //remove this attribute if you don't want all singletons to be set before the first scene loads
    ...
    public static void ForceAll()
    {
        ...
        { 
            ...
            { 
				...
				var singObj = UnityEngine.Object.FindObjectOfType(type);
                if (singObj)
                {
